...
class Day04(context: Context): Day(context,4,2021) {

    private val TAG= "GiantSquid"
    private val gridBoard: ArrayList<Array<IntArray>> = ArrayList()
    private val itemList= arrayListOf(84,28,29,75,58,71,26,6,73,74,41,39,87,37,16,79,55,60,62,80,64,95,46,
